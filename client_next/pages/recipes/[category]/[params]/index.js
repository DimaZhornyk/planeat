...
import {
  ...
  getTime,
  getUtensils,
} from "../../../../src/_reducers/recipes_reducer";
  ...
  return {
    props: {
      data: {
        ...
        categoriesUtensils: [
          { categoryName: "utensils", categoryDisplayNameUA: "Приладдя" },
        ],
        // data.categoriesUtensils,
...
function FilteredPage({
  ...
  //data.utensils.map(it => it.categoryName = "utensils")
...
const mapDispatchToProps = (dispatch, state) => {
  return {
    ...
    filterByTime: (minTime, maxTime) =>
      dispatch(filterByTime(minTime, maxTime), state),
    filterByCalories: (minTime, maxTime) =>
      dispatch(filterByCalories(minTime, maxTime), state),
  };
};
