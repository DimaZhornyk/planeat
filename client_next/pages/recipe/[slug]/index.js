...
function RecipePage({ recipe, categories }) {
  ...
  const getDishes = recipe.utensils.map((utensil) => {
    return (
      <li
        className={styles["utils-list-container"]}
        itemProp={"recipeIngredient"}
        content={utensil.caption}
      >
        <CustomOptionCard
          item={utensil}
          className={styles["utils-icon"]}
          size={"40px"}
        />
      ...
      <Col xs={12} sm={12} md={12} lg={12} xl={12}>
        <li className={styles["utils-list-container"]}>
          <CustomOptionCard
            ...
            size={"40px"}
          />
          <p style={{ margin: "0 0 0 15px", fontSize: "12px" }}>
            {product.caption}
          </p>
        </li>
      </Col>
                ...
                {recipe.utensils.length !== 0 && (
                  <>
                    <div className={styles["dishes"]}>
                      ...
                      <Scrollbars universal={true}>{getDishes}</Scrollbars>
                    </div>
                  </>
                )}
                {recipe.products.length !== 0 && (
                  <>
                    <div className={styles["ingredients"]}>
                      ...
                      <Scrollbars universal={true}>{getIngredients}</Scrollbars>
                    </div>
                  </>
                )}
              </div>
