    ...
    return (
        <>
            <Head>
                ...
                <meta name={"description"} content={"Заходьте на Planeat та знаходьте смачні рецепти на кожен день. Тут ви знайдете швидкі рецепти на сніданок, обід та вечерю. Також ви завжди зможете дивувати рідних швидкими рецептами десертів на кожен день."}/>
            </Head>
